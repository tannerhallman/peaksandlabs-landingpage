    ...
    <div className='space-y-16 bg-background text-dark'>
      ...
      <section
        ...
        <div className='relative z-10 text-center text-white bg-dark bg-opacity-50 p-8 rounded-lg'>
          ...
          <p className='text-xl mb-8'>
            Experience the freedom of the open road in our fully-equipped 2018
            Dodge Ram Promaster campervan.
          </p>
          <Link
            href='/booking'
      ...
      <AnimatedSection className='container mx-auto px-4'>
        ...
        <div className='flex flex-col md:flex-row items-center'>
          ...
          <div className='md:w-1/2'>
            ...
            <p className='mb-4'>
              Our fully-equipped campervan is perfect for your next adventure.
              With a comfortable interior and all the amenities you need,
              you&apos;ll have the freedom to explore in style.
            </p>
        ...
        <div className='container mx-auto px-4'>
          ...
          <div className='grid grid-cols-1 md:grid-cols-3 gap-8'>
            <div className='bg-background p-6 rounded-lg shadow-md'>
              ...
              <p>
                Our campervan is designed for maximum comfort, ensuring you have
            ...
            <div className='bg-background p-6 rounded-lg shadow-md'>
              ...
              <p>
                Equipped for both summer and winter trips, our van is perfect
            ...
            <div className='bg-background p-6 rounded-lg shadow-md'>
              ...
              <p>
                Our simple online booking process makes it easy to plan your
                next getaway.
              </p>
            </div>
          </div>
        ...
        <div className='flex flex-col md:flex-row items-center justify-center space-y-8 md:space-y-0 md:space-x-16'>
          <div className='text-center'>
            ...
            <p className='max-w-md'>
              We&apos;re passionate about travel and the great outdoors. Our
              goal is to share the joy of van life with fellow adventurers.
            </p>
          </div>
          <div className='text-center'>
            <Image
            ...
            <p className='max-w-md'>
              Our furry companions and unofficial mascots. They love adventure
              as much as we do!
            </p>
          </div>
        </div>
      ...
      <AnimatedSection className='bg-primary text-white py-16'>
        <div className='container mx-auto px-4 text-center'>
          ...
          <p className='text-xl mb-8'>
            Book our campervan today and start exploring!
          </p>
          <Link
            href='/booking'
